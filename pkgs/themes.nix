...
in {
  ...
  kvlibadwaita = stdenv.mkDerivation {
    ...
    postFixup = ''
      sed -i -E 's/(transparent_.+=)true/\1false/g' $out/share/Kvantum/KvLibadwaita/KvLibadwaitaDark.kvconfig
      #rm $out/share/Kvantum/KvLibadwaita/KvLibadwaitaDark.kvconfig
